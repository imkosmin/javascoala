 ...
 * @author hcosm
 */
public class Typeracergame extends javax.swing.JFrame {
...
// "<html>H<font color='red'>e</font>llo World!</html>"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Typeracergame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Typeracergame().setVisible(true);
            }
        });
    }
int linesnumber=0;
